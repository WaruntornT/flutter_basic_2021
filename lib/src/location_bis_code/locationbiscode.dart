...
class LocationBisCode extends StatefulWidget {
  const LocationBisCode({Key key}) : super(key: key);

  @override
  _LocationBisCodeState createState() => _LocationBisCodeState();
}

class _LocationBisCodeState extends State<LocationBisCode> {
